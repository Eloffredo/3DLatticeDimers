...
parser.add_argument("-t", "--typeofint",  type = int, default=2, help="Specify if monomeric or dimeric interaction is desired")
...
OUTPUT_PATH = f'./data/MeanEvolution_beta_{beta}_gamma_{gammaint}_struct_a{s1}_b{s2}blob.txt'.format(beta,gammaint, s1,s2)
